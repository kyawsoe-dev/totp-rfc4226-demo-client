...
function Dashboard({ apiUrl, token, username }) {
            ...
            <div key={device.id} className="device-card">
              <div className="device-info">
                ...
                <span className={`status ${device.confirmed ? 'confirmed' : 'pending'}`}>
                  {device.confirmed ? 'Confirmed' : 'Pending'}
                </span>
              </div>
        ...
        <div className="add-device-section">
          {!showAddDevice && (
            <div className="setup-2fa-section">
              <h3>Setup 2FA with Mobile Authenticator</h3>
      ...
      <section className="backup-section">
        ...
        {showBackupCodes && (
          <div className="backup-codes-display">
            <p className="warning">Save these codes! You won't see them again.</p>
